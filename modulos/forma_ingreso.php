    ...
    <thead>
        <tr>
            <th class="text-center"  style="color:#3c763d; padding-bottom:60px;" colspan="2" >
                <h3 class="poppins" style="color:#3c763d;">POR FAVOR SELECCIONE FORMA DE INGRESO</h3>
            </th>
        </tr>
    </thead>
    <tbody>
            ...
            <td style="width:50%;">
                <div class="teaser with_border rounded text-center pt-0 m-0" style="cursor: pointer;" onclick="">
                    <h4 class="poppins hover-color2 text-left m-0 p-0">
                        <a class="m-0" href="index.php?<?php echo util::encodeParamURL('pth=perfilacion_rut&from='.$from.''); ?>">RUT TITULAR</a>
                    </h4>
                </div>
            </td>
            <td  style="width:50%;" >
                <div class="teaser with_border rounded text-center" style="cursor: pointer;" onclick="">
                    <h4 class="poppins hover-color3 text-right m-1 p-1">
            ...
            <td style="width:50%;">
                <div class="teaser with_border rounded text-center" style="cursor: pointer;" onclick="">
                    <h4 class="poppins hover-color3 text-right">
                        <a class="m-0" href="index.php?<?php echo util::encodeParamURL('pth=banco_falabella'); ?>">VOLVER A MENU PRINCIPAL</a>
                    </h4>
                </div>
            </td>
        </tr>
